...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field taken_by on 'Course'
        m2m_table_name = db.shorten_name(u'recomendr_course_taken_by')
    ...
    def backwards(self, orm):
        # Removing M2M table for field taken_by on 'Course'
        db.delete_table(db.shorten_name(u'recomendr_course_taken_by'))
